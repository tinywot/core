...
struct tinywot_payload *tinywot_test_payload_new(size_t size) {
...
struct tinywot_thing *tinywot_test_thing_new(void) {
...
struct tinywot_thing *tinywot_test_thing_new_example(void) {
  struct tinywot_thing *thing =
    tinywot_test_malloc0(sizeof(struct tinywot_thing));
